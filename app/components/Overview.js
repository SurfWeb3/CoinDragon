...
/* State for Account Modal (open true / open false) 
"isAccountModalOpen" is a variable for: account modal open true/false 
"setAccountModalOpen" is a function for changing the value true/false 
useState(false) lets us save that state, by default it is false */
...
const calculatePercentageChange = () => {
  ...
  for(var i =0; i < tokens.length; i++) {
    if(tokens[i].balance === 0) { continue }
/* Get past and current values, with 24 hour change */

...
/* Loops through tokens [ETH, USDC, MATIC, etc] */
      for (let j = 0; j < tokens[i].prices.length; j++) {
/* Loops through prices of each token (one token at a time), 
iterating once for each day/period on graph [3499, 3425, etc] */
